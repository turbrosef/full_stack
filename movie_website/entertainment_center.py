...
"""
Creates six objects of the type Movie. Each of the objects will be
intialized with the
title, storyline, url to the movie poster and url to the movie's
trailer in youtube.
"""

lampoon_vacation = media.Movie(
  "National Lampoon's Vacation",
  "A family's road trip across the"
  "United States to visit a amusment park takes some WILD turns!",
...
airborne = media.Movie(
  "Airborne",
  "Mitchell is moved to a new town and finds trouble and love",
  "https://www.podnapisi.net/thumbnails/moviedb/normal/PwM.jpg",
  "https://www.youtube.com/watch?v=Mz2CMDCD3WQ")

happy_gilmore = media.Movie(
  "Happy Gilmore",
  "A wannabe hockey pro finds a new calling in golf"
  ", to save his grandmother house.",
  "http://img.moviepostershop.com/"
  "happy-gilmore-movie-poster-1996-1020189601.jpg",
  "https://www.youtube.com/watch?v=y1emDAYCfVQ")

over_the_top = media.Movie(
  "Over the Top",
...
anchorman = media.Movie(
  "Anchorman",
  "A 70's Achorman was king,"
  "until a woman co-anchor challeged for the throne.",
  "https://s-media-cache-ak0.pinimg.com/originals/c5/61/44/"
  "c561448d4b9360e83d91d62e9449866c.jpg",
...
"""
create HTML and opens the a website in the local default browser.
It shows the movies listed above
"""
